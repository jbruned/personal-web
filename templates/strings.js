...
const EN = Object.assign({}, generated_strings.en, {
    ...
    eras_title: 'Master Computer Science',
    ...
    clarinet: 'Professional Music Education (Clarinet)',
    eoi_sabi: "Official Language School (Spain)",
    cpm_sabi: "Professional Music School (Spain)",
    dgt_hue: "Spain",
    experience_brief: "Throughout my career, I have worked on truly diverse projects, always with the aim of acquiring new knowledge and broadening my horizons",
    ...
    fb_content: "During several years, I have carried out several sporadic tasks concerning hardware and software deployment, installation and maintenance for this SME. " +
        "These experiences have provided me with a broad vision of the real needs of a business and enabled me to face real-life problems.",
	...
	veridas_1: "During my first year in Veridas, I worked part-time as a frontend developer while taking my Master's degree, focusing on native apps. Some of my tasks included:",
    ...
    veridas_2a: "Currently, I'm working part-time as a Machine Learning Engineer focused on computer vision models for identity document analysis, such as object detection, classification, etc. I have developed models that accumulate millions of inferences in production.",
    veridas_2b: "My tasks range from researching and conceiving new models from scratch, to their integration and evaluation in product, as well as their deployment and monitoring in production.",
    veridas_2c: "Some of the problems I've tackled at a technical level include instance segmentation, optical character recognition (OCR), open set classification, and anti-spoofing.",
    veridas_2d: "On top of that, I've had the opportunity of mentoring students, supervise both Bachelor's and Master's theses, actively participate in decision-making, and attend international conferences such as ICDAR.",
    portfolio: "Portfolio",
